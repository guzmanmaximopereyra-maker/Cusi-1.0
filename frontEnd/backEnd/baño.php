...
<body>
   <section class="baño">
      <div class="botones">
         <button onclick="irA('backEnd/cocina.php')" class="arrow_l"><img src="../Cusi_style/left.png" width="70"></button>
         <button onclick="irA('backEnd/pieza.php')" class="arrow_r"><img src="../Cusi_style/right.png" width="70"></button>
